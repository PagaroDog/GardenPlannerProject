...
/**
 * This class is the controller for the Save screen. Handles user input.
 * 
 * @author Josh Stone
 * 
 */
public class SaveController extends Controller<SaveView> {
	...
	/**
	 * Handles event when user presses File button, invoking fileButton()
	 * 
	...
	/**
	 * Handles event when user presses PNG button, invoking PNGButton()
	 * 
	 * @return EventHandler object for this action
	 */
	 ...
	 * 
	 * @param event The MouseEvent generated when the user pressed the file button.
	 */
	 ...
	 * 
	 * @param event The MouseEvent generated when the user pressed the png button.
	 */
	 ...
	 * 
	 * @param event The MouseEvent generated when the user pressed the prev button.
	 */
