...
public class ModelTests {
	...
	public void parseLineTest2() {
		List<String> results = Model
				.parseLine("\"result0-0, result0-1\",result1,result2,\"result3-0, result3-1, result3-2, result3-3\"");
	...
	public void generateStatsTest() {
		...
		String[] plants = { "Achillea millefolium", "Achillea millefolium", "Acer negundo", "Acer spicatum",
				"Ceanothus americanus", "Lonicera sempervirens", "Staphylea trifolia" };
		...
		double expectedCoverage = Math.pow(defaultRadius, 2) * Math.PI * plants.length / test.getPropertyHeightInches()
				/ test.getPropertyWidthInches() * 100;
