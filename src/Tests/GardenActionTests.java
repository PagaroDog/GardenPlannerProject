...
public class GardenActionTests {
	...
	public void addActionTest() {
		...
		GardenAction actionOne = new GardenAction(testPlant, testX, testY, testRadius, testName, testColor,
				ActionEnum.ADDPLANT);
		...
		GardenAction actionTwo = new GardenAction(testPlant, testX + testMoveX, testY, testRadius, testName, testColor,
				ActionEnum.MOVEPLANT);
		...
		GardenAction actionThree = new GardenAction(testPlant, testX + testMoveX, testY, testRadius, testName,
				testColor, ActionEnum.MOVEPLANT);
		...
		testX += testMoveX;
		testY += testMoveY;
		GardenAction actionFour = new GardenAction(testPlant, testX + testMoveX, testY, testRadius, testName, testColor,
				ActionEnum.MOVEPLANT);
